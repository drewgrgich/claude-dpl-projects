...
SPECTATOR_CARDS = [
    ...
    {"id": 5,  "emoji": "😤", "name": "The Jeering Rival",
     "desc": "Player who lost last round discards 2 cards"},
    {"id": 6,  "emoji": "🔥", "name": "The Underdog Cheer",
     "desc": "Fewest FP player rolls 5 dice (max 2/Ring still applies)"},
    {"id": 7,  "emoji": "🎪", "name": "The Wild Card Toss",
     "desc": "Dump top 3 deck cards into Stunt Pool, then refill to 6"},
    {"id": 8,  "emoji": "🃏", "name": "The Card Shark",
     "desc": "All players swap one card at a chosen Ring"},
    {"id": 9,  "emoji": "👑", "name": "The Champion's Welcome",
     "desc": "Most Trophies draws 2 cards"},
    {"id": 10, "emoji": "💥", "name": "The Chaos Round",
     "desc": "All dice = 0 this round — cards only"},
